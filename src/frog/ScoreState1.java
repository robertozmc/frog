...
/**
 * Klasa - stan, będąca menu wyników dla pierwszego poziomu gry 
...
public class ScoreState1 extends BasicGameState {
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		LoadData.uniFont.drawString(gc.getWidth()/2-LoadData.uniFont.getWidth(LoadData.scoreText + LoadData.points1)/2,
				gc.getHeight()/2-LoadData.uniFont.getHeight(LoadData.scoreText + LoadData.points1),
				LoadData.scoreText + LoadData.points1);
